...
export const metadata = { title: 'Reminder App | Minimalist Planner', description: 'Bring your daily notes, calendars, and to-do lists into one beautifully simple workspace.' };
